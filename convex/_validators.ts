// Inlined from @open-vault/shared/validators — Convex bundler cannot resolve workspace packages
import { z } from "zod";
import {
  PROJECT_NAME_REGEX,
...
export const CreateProjectSchema = z.object({
  name: z.string().regex(PROJECT_NAME_REGEX, "Invalid project name"),
